...
const Testimonials = () => {
  return (
    <section className="bg-gray-50 text-xl text-black w-full text-center h-auto border-t-4 mx-5 border-black flex flex-col items-center justify-start py-5 lg:mt-5 mt-[35rem] py-10 ">
